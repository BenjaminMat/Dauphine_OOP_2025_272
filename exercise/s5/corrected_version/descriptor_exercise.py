...
class UpperTicker:
    ...
    def __set__(self, obj, value):
        ...
        setattr(obj, self.storage_name, s)
...
class DailyReturn:
    ...
    def __get__(self, obj, objtype=None):
        ...
        if prev_close == 0:
            raise ZeroDivisionError("prev_close is zero")
        return (price / prev_close) - 1
...
if __name__ == "__main__":
    ...
    asset: FinancialAsset = FinancialAsset("aapl", 150.0, 148.0)
    ...
    # asset.prev_close = -0.2        # ZeroDivisionError on asset.daily_return
    # asset.prev_close = 0          # setting up zero div error for daily return
